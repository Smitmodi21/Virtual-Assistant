...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            print("\n")
            exit()
        elif 'email to smit' in query:
            try:
                print("What Should I Say?")
                content = takeCommand()
                to = "artimodi2302@gmail.com"
            ...
            print("I was Designed or Created by Smit.")
            ...
            print("My Owner Name is Smit Modi, And He is a Software Developer.")
